                ...
                if(rs.next()){
                    ...
                    if(user.equals("Customer")){
                        if(status.equals("block")){
                            new window_after_block(meter, user).setVisible(true);
                            }
                        else {
                        ...
                        else if(status.equals("not accepted")){
                            JOptionPane.showMessageDialog(null, "Your new account request is not accepted by any admins");
                            }  
                        else{
                            new Project(meter, user,a ).setVisible(true);
                        }
